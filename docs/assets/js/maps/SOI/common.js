...
// TODO: pull from a more shared folder?
...
const parseListing = (listingText) => {
...
export function getStatusData(cb) {
    ...
    const collate = () => {
        ...
        var statusInfo = {};
        for (const sheetNo in pdfSizeData) {
        ...
        for (const sheetNo in gtiffSizeData) {
